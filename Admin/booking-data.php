                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Booking Data <img src="https://img.icons8.com/color/20/000000/add-ticket.png"/></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">BOOKING DATA <img src="https://img.icons8.com/color/30/000000/add-ticket.png"/></strong>
                                 <a href="enquiryadd.php" class="btn btn-info" style="padding-left: 50px;border-radius:20px">Add Data</a>
                            </div>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <th> <?php echo $row ['adult']; ?> </th>
                                            <th> <?php echo $row ['child']; ?> </th>
                                            <th> <?php echo $row ['departdate']; ?> </th>
