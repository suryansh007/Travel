...
<body>
  ...
  <!-- case_details_area  -->
  <h1 class="details_info" style="text-align: center; color: chartreuse;">
        ...
        <div class="row">
          ...
          <div class="col-xl-9">
            <div class="details_main_wrap">
              <p class="details_info" style="color: white;">
              ...
              <div class="single_details">
                <span style="color: yellowgreen;">Problem</span>
                <p style="color: white;">
                  Esteem spirit temper too say adieus who direct esteem. It
                  esteems luckily or picture placing drawing. Apartments
                  frequently or motionless on reasonable sed do eiusmod tempor
                  inciunt ut labore et dolore magna liqua.abore et dolore
                  incididunt ut labore et dolore magna liqua abore et dolore
                </p>
              </div>
              <div class="single_details">
                <span style="color: yellowgreen;">Solution</span>
                <p style="color: white;">
                  Esteem spirit temper too say adieus who direct esteem. It
                  esteems luckily or picture placing drawing. Apartments
                  frequently or motionless on reasonable sed do eiusmod tempor
              ...
              <div class="single_details">
                <span style="color: yellowgreen;">Result</span>
                <p style="color: white;">
                  Esteem spirit temper too say adieus who direct esteem. It
                  esteems luckily or picture placing drawing. Apartments
                  frequently or motionless on reasonable sed do eiusmod tempor
