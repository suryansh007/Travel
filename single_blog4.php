...
<body>
  ...
  <div class="containerblog">
    ...
    <div class="frame-square">
      <img src="images/blog/blog4.jpg" alt="a wide image" title="wide image" />
    </div>

    <br /><br />

    <p>
      New York’s famous Metropolitan Museum of Arts, also known as The Met, is
      going to open its doors soon after remaining in lockdown since March 13.
      It is the largest art museum in the United States, and is known to
      attract a large number of visitors each year. However, the museum is not
      the same as it once was, in a new world of social distancing, The Met is
      also going to be all new.
    </p>
    ...
    <div class="frame-square">
      <img src="images/blog/blog4a.jpg" alt="a wide image" title="wide image" />
    </div>

    <br /><br />

    <p>
      The museum is slated to open in mid-August, or a few weeks later, which
      depends on the phases in which New York reopens its businesses. The Met
      is located in three locations, namely, The Met Cloisters, The Met
      Breuer, and the Met Fifth Avenue. New York City’s Governor Andrew Cuomo
      has laid out benchmarks for reopening, seven of them, and that is how
      things are going to roll out henceforth. The benchmarks include
      information, such as testing per capita, contact tracing capabilities,
      and ICU capacity.
    </p>
    ...
    <div class="frame-square">
      <img src="images/blog/blog4b.jpg" alt="a wide image" title="wide image" />
    </div>
