...
<body>
	...
	<section class="contact py-5 ">
		<div class="container py-lg-5 py-sm-4">
			<h2 class="heading text-capitalize text-center mb-lg-5 mb-4" style="color: white;padding:30px;">Group Luxury Tour !</h2>
		</div>

	</section>

	<!-- The App Section -->
	<div class="container" style="background-color:#f1f1f1;border-radius: 20px;padding: 20px;margin-top: -100px;">
		<div class="row">
			<div class="column-66">
				<h1 class="xlarge-font"><b>Agra Package</b></h1>
				...
				<br>
				<a href="agraluxury.php"><button class="button">View Package</button></a>
			</div>
			<div class="column-33">
				<img src="images/luxury/lux1.jpg" width="335px" height="500" style="border-radius: 10px;">
			</div>
		</div>
	</div>
	<br>
	...
	<div class="container" style="background-color:#f1f1f1;border-radius: 20px;">
		<div class="row">
			<div class="column-33">
				<img src="images/luxury/lux2.jpg" alt="App" width="335" height="471" style="border-radius: 10px;">

			</div>
			<div class="column-66">
				<h1 class="xlarge-font"><b>Mysuru Package</b></h1>
				...
				<br>
				<a href="mysuruluxury.php"><button class="button" style="background-color:red">View Package</button></a>
			</div>
		</div>
	</div>
	<br>
	...
	<div class="container" style="background-color:#f1f1f1;border-radius: 20px;">
		<div class="row">
			<div class="column-66">
				<h1 class="xlarge-font"><b>Jaipur Package</b></h1>
				<h1 class="large-font" style="color:MediumSeaGreen;"><b>Why buy it?</b></h1>
			...
			<div class="column-33">
				<img src="images/luxury/lux3.jpg" width="335" height="471" style="border-radius: 10px;">
			</div>
		</div>
	</div>
	<br>
	...
	<div class="container" style="background-color:#f1f1f1;border-radius: 20px;">
		<div class="row">
			<div class="column-33">
				<img src="images/luxury/lux4.jpg" alt="App" width="335" height="471" style="border-radius: 10px;">
			</div>
			<div class="column-66">
				<h1 class="xlarge-font"><b>Delhi Package</b></h1>
				<h1 class="large-font" style="color:red;"><b>Pixels, who?</b></h1>
				<p><span style="font-size:24px">A revolution in resolution.</span> Sharp and clear photos with the world's best photo engine, incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquipex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
				<br>
