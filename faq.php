...
<body>
  ...
  <section class="contact py-5">
    <div class="container py-lg-5 py-sm-3">
      <h2 class="heading text-capitalize text-center mb-sm-5 mb-4" style="color: white;">
      ...
      <ul class="list-unstyled row text-center mt-lg-5 mt-4 px-lg-5">
        <li class="col-md-4 col-sm-6 adress-w3pvt-info">
          ...
          <h6 style="color: lawngreen;">Location</h6>
          <p style="color: white;">
            Travel .IO <br />Mumbai , Maharatshtra , INDIA
          </p>
        </li>
        ...
        <li class="col-md-4 col-sm-6 adress-w3pvt-info mt-sm-0 mt-4">
          ...
          <h6 style="color: lawngreen;">Phone & Email</h6>
          <p style="color: lightseagreen;">+91 8321965348</p>
          <a href="info@travelio.site" class="mail" style="color: lightseagreen;">info@travelio.site</a>
        </li>
        <li class="col-md-4 col-sm-6 adress-w3pvt-info mt-md-0 mt-4">
          ...
          <h6 style="color: lawngreen;">Stay In Touch</h6>
