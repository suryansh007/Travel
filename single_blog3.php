...
<body>
  ...
  <div class="containerblog">
    <h3 style="text-align: center;">
      Dubai is back in business; reopens beaches and major parks
    </h3>

    <br /><br />

    <div class="frame-square">
      <img src="images/blog/blog3.jpg" alt="a wide image" title="wide image" />
    </div>

    <br /><br />

    <p>
      Dubai reopens beaches and popular parks today. Referring to this, the
      Dubai Municipality stated that they are reopening Jumeirah, JBR, Al
      Mamzar, and Umm Suqeim beaches. Officials in the know-how stated that
      the sites opening to the members of public, must adhere to the standard
      guidelines and safety measures issued. The said announcement was made
      late on Thursday on the official Instagram account of Dubai
      Municipality. The post also urged the citizens to abide by the public
      safety measures to ensure safety and security of the community.
      Following this announcement, the Dubai Municipality also informed in
      another post that they are opening the major parks and the Dubai Frame.
    </p>
    ...
    <div class="frame-square">
      <img src="images/blog/blog3a.jpg" alt="a wide image" title="wide image" />
    </div>

    <br /><br />

    <p>
      On Wednesday, Dubai eased the movement restrictions, and shortened the
      stay home order from 11 PM to 6 AM. As per these latest relaxed rules,
      Dubai companies are allowed to reopen with half of their staff, whereas
      entertainment centres, cinemas, gyms, and ice rinks have been reopened.
      Reportedly, Dubai museums will be reopening in a phased manner from June
      1. Further, anyone visiting public places is expected to wear face masks
      all the time, or else they face the risk of paying fines. Also, as
      reported earlier, Dubai, in all likelihood, will start welcoming
      tourists once again from July 2020 after putting a stop on tourist
      arrivals to contain the spread of Coronavirus. Also, as per a meeting of
      Dubai’s Supreme Committee of Crisis & Disaster Management, which was
      chaired by HH Sheikh Hamdan, Dubai is officially back in business.
    </p>
