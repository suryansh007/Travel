...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Cinzel+Decorative&family=Mulish:wght@300&display=swap" rel="stylesheet">
        ...
        <div class="col-lg-8 posts-list">
          <div class="single-post">
            <div class="feature-img">
              <h2 style="color: white;text-align:center;font-family:serif;">
              ...
              <img class="img-fluid" src="images/webinar/webinar1.jpg" alt="" style="width:100%" />
            </div>
            <div class="blog_details" style="font-size: 11px;">

              <br />
              <br>
              <p class="excert" style="color: white; text-align: center;">
                The Covid-19 tally in India rose to 1,238,635 on Thursday after over 45,000 fresh cases were registered within a span of 24 hours. The death toll also increased from 28,732 to 29,861.
              ...
              <p style="color: white; text-align: center;">
                ...
                <br>
                <br>
                <em style="color:lawngreen">Globally, as many as 15,177,447 people have been infected with the novel coronavirus. While 622,183 fatalities have been recorded, 8,608,400 others have recovered till now.</em>
              </p>
              <br>
              <div class="feature-img">
                <img class="img-fluid" src="images/webinar/webinar1a.webp" alt="" />
              </div>
              <br>
              <br />
              <div class="feature-img">
                <img class="img-fluid" src="images/webinar/webinar1b.png" alt="" />
              </div>
              <br />
              <br />
              <div class="feature-img">
                <img class="img-fluid" src="images/webinar/webinar1c.jpg" alt="" />
              </div>
              <br />
              <br />
              <div class="feature-img">
                <img class="img-fluid" src="images/webinar/webinar1d.webp" alt="" />
              </div>
              <br />
              <br />
              <div class="feature-img">
                <img class="img-fluid" src="images/webinar/webinar1e.jpg" alt="" />
              </div>
              <br />
              <br />
              <h2 style="color: white;text-align:center;font-family:serif;">
              ...
              <br>
              <div class="feature-img">
                <img class="img-fluid" src="images/webinar/webinar1f.jpg" alt="" />
              </div>
              <br />
              <br />

              <div class="container1">
                <iframe class="responsive-iframe" src="https://www.youtube.com/watch?v=i0ZabxXmH4Y"></iframe>
              </div>
              <br>
              <br>
            </div>
