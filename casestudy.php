...
<body>
  ...
  <ul class="breadcrumb">
    ...
    <li><a href="casestudy.php">CaseStudy</a></li>
    <li style="color: yellowgreen;">Cases</li>
  </ul>
  <br />
  <br />
  <!-- case_study_area  -->
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single_study text-center white_single_study">
            ...
            <div class="subheading white_subheading">
              <h4><a href="Case_details.php">Custom Website</a></h4>
              <p>UI/UX, Design</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="single_study text-center white_single_study">
            ...
            <div class="subheading white_subheading">
              <h4><a href="Case_details.php">Digital Marketing</a></h4>
              <p>UI/UX, Design</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="single_study text-center white_single_study">
            ...
            <div class="subheading white_subheading">
              <h4><a href="Case_details.php">Product Design</a></h4>
              <p>UI/UX, Design</p>
            </div>
          </div>
        </div>
