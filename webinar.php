...
<head>
  ...
  <link href="css/webinar.css" rel="stylesheet" type="text/css" />
...
<body>
  ...
  <ul class="breadcrumb">
    ...
    <li style="color: yellowgreen;">Videos</li>
  </ul>
  <br />
  <br />
  <!-- 
																	...
																	case_study_area   Webinar Images Are width (640--430)
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single_study text-center white_single_study">
            <div class="thumb">
              <a href="webinar_covid19.php">
                <img src="images/webinar/webinar1.jpg" alt="" />
              </a>
            </div>
            <div class="subheading white_subheading">
              <h4><a href="webinar_covid19.php">Lets Talk About Covd-19</a></h4>
              <p></p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single_study text-center white_single_study">
            <div class="thumb">
              <a href="webinar_machinelearning.php">
                <img src="images/webinar/webinar2.jpg" alt="" />
              </a>
            </div>
            <div class="subheading white_subheading">
              <h4>
                <a href="webinar_machinelearning.php">Machine Learning for All</a>
              </h4>
              <p></p>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single_study text-center white_single_study">
            <div class="thumb">
              <a href="#!">
                <img src="images/casestudy/3.png" alt="" />
              </a>
            </div>
            <div class="subheading white_subheading">
          ...
          <div class="single_study text-center white_single_study">
            <div class="thumb">
              <a href="Case_details.html">
                <img src="images/casestudy/4.png" alt="" />
              </a>
            </div>
            <div class="subheading white_subheading">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single_study text-center white_single_study">
            <div class="thumb">
              <a href="Case_details.html">
                <img src="images/casestudy/5.png" alt="" />
              </a>
            </div>
            <div class="subheading white_subheading">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single_study text-center white_single_study">
            <div class="thumb">
              <a href="Case_details.html">
                <img src="images/casestudy/6.png" alt="" />
              </a>
            </div>
            <div class="subheading white_subheading">
              <h4><a href="Case_details.html">Digital Marketing</a></h4>
