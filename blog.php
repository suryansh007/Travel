...
<body>
  ...
  <section class="" id="">
    <div class="ban">
      <img src="images//blog/blogbanner.jpg" alt="if img dosent show up try refresh" width="100%" height="450px" />
    </div>
  </section>
  <!-- //banner -->
  <br />
  ...
  <div class="main">
    <h1>
      Latest Blog<img src="https://img.icons8.com/nolan/30/blogger.png" />
    </h1>
    <br />
    <br />
    <ul class="cards">
      <li class="cards_item">
        <div class="card">
          <div class="card_image"><img src="images/blog/blog2.jpg" /></div>
          <div class="card_content">
            <h2 class="card_title" style="text-align: center;">
              WILL THE CORONAVIRUS CHANGE HOW YOU LIVE?
            </h2>
            <br>
            <p class="card_text">March-23/2020</p>
            <a href="single_blog.php"><button class="btn card_btn"><span>Read More</span></button></a>
          </div>
        </div>
      </li>
      <li class="cards_item">
        <div class="card">
          <div class="card_image"><img src="images/blog/miami.jpg" /></div>
          <div class="card_content">
            <h2 class="card_title">Things to Do in Miami (Florida)</h2>
            <br>
            <p class="card_text">March-2/2020</p>
            <a href="single_blog2.php"><button class="btn card_btn"><span>Read More</span></button></a>
          </div>
        </div>
      </li>
      <li class="cards_item">
        <div class="card">
          <div class="card_image"><img src="images/blog/blog3.jpg" /></div>
          <div class="card_content">
            <h2 class="card_title">
              Dubai is back in business; reopens beaches and major parks
            </h2>
            <br>
            <p class="card_text">February-20/2020</p>
            <a href="single_blog3.php"><button class="btn card_btn"><span>Read More</span></button></a>
          </div>
        </div>
      </li>
      <li class="cards_item">
        <div class="card">
          <div class="card_image"><img src="images/blog/blog4.jpg" /></div>
          <div class="card_content">
            <h2 class="card_title">
              New York’s Metropolitan Museum of Arts to reopen soon
            </h2>
            <br>
            <p class="card_text">February-10/2020</p>
            <a href="single_blog4.php"><button class="btn card_btn"><span>Read More</span></button></a>
          </div>
        </div>
      </li>
      <li class="cards_item">
        <div class="card">
          <div class="card_image"><img src="images/blog/blog5.jpg" /></div>
          <div class="card_content">
            <h2 class="card_title">
              Best Things To See in Helsinki(Finland)
            </h2>
            <br>
            <p class="card_text">February-10/2020</p>
            <a href="single_blog5.php"><button class="btn card_btn"><span>Read More</span></button></a>
          </div>
        </div>
      </li>
      <!------
	  <li class="cards_item">
		<div class="card">
		  <div class="card_image"><img src="images/blog/blog6.jpg"></div>
		  <div class="card_content">
			<h2 class="card_title">Card Grid Layout</h2>
			<p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
			<button class="btn card_btn"><span>Read More</span></button>
		  </div>
		</div>
	  </li>
  ...
  <div class="footera">
    <div class="centerp">
      <div class="pagination">
        <a href="blog.php">&laquo;</a>
        <a href="blog.php" class="active">1</a>
        <a href="blog_2.php">2</a>
        <a href="blog3.php">3</a>
        <a href="blog4.php">4</a>

        <a href="blog4.php">&raquo;</a>
      </div>
    </div>
  </div>
