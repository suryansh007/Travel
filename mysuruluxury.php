...
<head>
	...
	<link href="css/luxurypack.css" rel='stylesheet' type='text/css' /><!-- custom css -->
...
<body>
	...
	<section class="" id="">
		<div class="lux">
			...
			<img src="images/luxury/mysuru/img1.jpg" alt="Smiley face" width="100%" height="470px">
	...
	<div class="container">
		<h1 class="project-name">MYSURU Luxury Day Plan</h1>
		<div id="timeline">
	...
	<a href="#" class="btn" style="margin-left: 50%;">BOOK NOW</a>
